...
//9000 IPC接入
    ...
    public static final int MAX_VEHICLE_TYPE_NUM = 8;  //车辆信息管控最大数
    /*******************全局错误码 begin**********************/
...
NativeLong NET_DVR_UploadFile_V40(int lUserID, int dwUploadType, Pointer lpInBuffer, int dwInBufferSize, String sFileName, Pointer lpOutBuffer, int dwOutBufferSize);
